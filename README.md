...
```
cd existing_repo
git remote add origin https://gitlab.com/certified/library-system.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/certified/library-system/-/settings/integrations)
